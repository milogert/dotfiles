...
local gray1 = vim.g.srcery_gray1
local gray2 = vim.g.srcery_gray2
local gray3 = vim.g.srcery_gray3
local gray4 = vim.g.srcery_gray4
local gray5 = vim.g.srcery_gray5
local gray6 = vim.g.srcery_gray6
